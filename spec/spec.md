...
- **FR-010**: The system MUST support the operations listed in [specs/Operations.md](../Operations.md): add, sub, eq, mult, pow, det, tr, T, ref, rref, dist, angle, dot, qr, diag, solve, inv, rank, lstsq, eig, schur, jnf, norm, svd, and gs, plus the boolean predicates isIdentity, isDiagonal, isSymmetric, isUpperTriangular, isOrthogonal, isOrthonormal, isIndependent.
